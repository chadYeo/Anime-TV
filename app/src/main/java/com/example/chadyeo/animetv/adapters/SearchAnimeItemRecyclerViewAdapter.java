...
public class SearchAnimeItemRecyclerViewAdapter extends RecyclerView.Adapter<SearchAnimeItemRecyclerViewAdapter.ViewHolder> {
    ...
    private SearchAnimeFragment.OnSearchAnimeFragmentInteractionListener mListener;

    public SearchAnimeItemRecyclerViewAdapter(ArrayList<Anime> items, SearchAnimeFragment.OnSearchAnimeFragmentInteractionListener listener) {
    ...
    @NonNull
    @Override
    public SearchAnimeItemRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.anime_item, parent, false);
        return new SearchAnimeItemRecyclerViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SearchAnimeItemRecyclerViewAdapter.ViewHolder holder, int position) {
