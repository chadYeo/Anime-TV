...
public class TVAnimeItemRecyclerViewAdapter
        extends RecyclerView.Adapter<TVAnimeItemRecyclerViewAdapter.ViewHolder> {

    private ArrayList<Anime> mValues = new ArrayList<>();
    private TVAnimeFragment.OnTVAnimeFragmentInteractionListener mListener;

    public TVAnimeItemRecyclerViewAdapter(ArrayList<Anime> items, TVAnimeFragment.OnTVAnimeFragmentInteractionListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TVAnimeItemRecyclerViewAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.anime_item_imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mListener.onTVAnimeFragmentInteraction(holder.mItem);
            }
        });
    }
